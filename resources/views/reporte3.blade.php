...
@section('script')
    ...
    <script src="{{ asset('public/Js/Actividad/reporte3.js') }}"></script>
...
@section('content') 
    <div class="content" id="reporte" class="row" data-url="Reporte">
        <br>
          <h3 id="navbar">Reporte de Actividades</h3>
        <br><br>
		<div class="panel panel-primary">
			    <div class="panel-heading">
			    		<h3 class="panel-title">BUSCADOR: buscador para el reporte de datos de las aprobación de actividades.</h3>
			    </div>
			    <div class="panel-body">
					<fieldset>
						<form action="" id="form_reporte3">
		...
		<div class="content">
	        <div class="panel panel-primary">
	            ...
	            <div class="panel-body" style="overflow: auto" Id="resultado">
	            	<table id="actividadesTabla" class="display nowrap" cellspacing="0" width="100%">
	                    <thead>
	                        <tr>
